<?php
	$pagetitle = 'Save Photo from Instagram Online Made in Easy';
	$pagedesc = 'Instagram Downloader: Get photo from Instagram without install any app by URL. Save pictures in just click.';
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="hero-content">
					...
					<?php
						if($_POST) { $result = '
						<img class="result-img" src="'.$variable.'/media/?size=l" alt="download instagram pictures">
						<a class="btn btn-default btn-success" href="'.$variable.'/media/?size=l" target="_blank">Download</a> '; 
						echo $result; }
					?>
				</div>
			</div>
